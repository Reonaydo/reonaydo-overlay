...
BASE_URI="http://developer.download.nvidia.com/compute/cuda/${DIR_V}/RC2/toolkit"
SRC_URI="amd64? ( ${BASE_URI}/cudatoolkit_${CUDA_V}.21_linux_64_ubuntu11.04.run )
	x86? ( ${BASE_URI}/cudatoolkit_${CUDA_V}.21_linux_32_ubuntu11.04.run )"
